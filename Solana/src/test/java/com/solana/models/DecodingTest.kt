...
class DecodingTests {
    ...
    fun testDecodingAccountInfo() {
        ...
        val buffer = Buffer(rawData, AccountInfoLayout(), AccountInfo::class.java)
        assertNotNull(buffer.value)
    ...
    fun testDecodingAccountInfo2() {
        ...
        val buffer = Buffer(string, AccountInfoLayout(), AccountInfo::class.java)
        assertNotNull(buffer.value)
        val accountInfo = buffer.value!!
        ...
        val buffer2 = Buffer(string2, AccountInfoLayout(), AccountInfo::class.java)
        assertNotNull(buffer.value)
